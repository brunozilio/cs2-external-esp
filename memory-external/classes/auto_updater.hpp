...
namespace updater {
	...
	const inline std::string github_repo_api = "https://api.github.com/repos/brunozilio/cs2-external-esp/commits";
	const inline std::string raw_updated_offsets = "https://github.com/brunozilio/cs2-external-esp/raw/main/offsets/offsets.json";
